...
public class Service__1 {
    ...
    @SerializedName("total_available_technician")
    @Expose
    private String totalAvailableTechnician;
    ...
    public String getTotalAvailableTechnician() {
        return totalAvailableTechnician;
    }

    public void setTotalAvailableTechnician(String totalAvailableTechnician) {
        this.totalAvailableTechnician = totalAvailableTechnician;
    }
